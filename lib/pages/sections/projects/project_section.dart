...
import 'package:jihen/pages/sections/projects/project_Data.dart';
...
class _ProjectSectionState extends State<ProjectSection> {
  ...
  Widget hideShowButton(BuildContext context) {
    return Center(
    ...
    return isMobile(context)
        ? Card(
            ...
            child: Stack(
              ...
              children: [
                image_builtItem(context, "assets/ppp.png"),
                Positioned(
        ...
        : Stack(
            ...
            children: [
              Positioned(
                  left: 10, child: image_builtItem(context, "assets/ppp.png")),
    ...
    return isMobile(context)
        ? Card(
            ...
            child: Stack(
              alignment: Alignment.center,
              children: [
                image_builtItem(context, "assets/jihen1.png"),
                Positioned(
                    child: description_builtItem(
                        context,
                        builtItem2_name,
        ...
        : Stack(
            ...
            children: [
              Positioned(
                  right: 10, child: image_builtItem(context, "assets/jihen1.png")),
    ...
    return isMobile(context)
        ? Card(
            ...
            child: Stack(
              alignment: Alignment.center,
              children: [
                image_builtItem(context, "assets/lll.png"),
                Positioned(
                    child: description_builtItem(
                        context,
                        builtItem3_name,
        ...
        : Stack(
            ...
            children: [
              Positioned(
                  left: 10, child: image_builtItem(context, "assets/lll.png")),
              description_builtItem(
                  context,
                  builtItem3_name,
                  "${builtItem3_des1 + '\n\n' + builtItem3_des2}",
